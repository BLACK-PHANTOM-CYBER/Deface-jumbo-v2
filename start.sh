...
yellow='\033[33;1m'
echo
toilet -f slant "JUMBO V2" | lolcat
echo
echo
echo
echo "silahkan gunakan tool ini dengan bijak" | lolcat
echo "thanks to:PUTRA-MR KING-SAHRUL-cLZXCLc-BLACK CYBER-FIREWOLF-RIYAN-LUTFI" | lolcat
echo
echo
echo
